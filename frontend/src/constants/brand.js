export const BRAND = {
  name: 'ShopSphere',
  tagline: 'Everything you need, delivered with care.',
...
export const CATEGORIES = [
  ...
  { label: 'Electronics', path: '/products', icon: '📱', description: 'Latest gadgets & tech' },
  { label: 'Home', path: '/products', icon: '🏠', description: 'Furnish your space beautifully' },
  { label: 'Beauty', path: '/products', icon: '✨', description: 'Skincare, makeup & wellness' },
