    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-stone-500">Manage all products available in JewelCart.</p>
        </div>
          ...
          <tbody>
            {loading ? (
              ...
              filteredProducts.map((product) => (
                <tr key={product.id} className="border-t border-stone-800 hover:bg-stone-900/40">
                  ...
                  <td className="px-5 py-4 text-stone-300">{product.category}</td>
                  ...
                  <td className="px-5 py-4 font-medium">₹{Number(product.msrp).toLocaleString('en-IN')}</td>

                  <td className="px-5 py-4">
                    <span className="rounded-full bg-stone-800 px-3 py-1 text-xs">{product.track_type}</span>
                  </td>

                  <td className="px-5 py-4">
                    <div className="flex justify-end gap-3">
                      <button onClick={() => openEditProduct(product)} className="text-blue-400 hover:text-blue-300">
                        <Pencil size={18} />
                      </button>
      ...
      {showProductModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="w-full max-w-2xl rounded-2xl bg-stone-900 p-8">
            <h2 className="mb-6 text-2xl font-semibold text-white">{editMode ? 'Edit Product' : 'Add Product'}</h2>
