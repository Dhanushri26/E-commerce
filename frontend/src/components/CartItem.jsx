    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <Link to={`/products/${key}`}>
          <h3 className="truncate text-base font-semibold text-slate-900 hover:text-indigo-600">
            {title}
          </h3>
        </Link>
      ...
      <div className="flex items-center justify-between gap-4 sm:flex-col sm:items-end">
        ...
        <button
          ...
          className={cn(
            'inline-flex items-center gap-1.5 text-sm text-red-600 transition hover:text-red-700'
          )}
        >
          <Trash2 size={14} />
          Remove
