        ...
        <div className="rounded-[2rem] border border-stone-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-8 space-y-4 text-sm text-stone-600">
            ...
            <div className="flex items-center gap-3">
              ...
              <span>24, Rosewood Avenue, Luxury District</span>
            </div>
          </div>
        </div>
        <div className="rounded-[2rem] border border-stone-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <input
              className="rounded-full border border-stone-200 bg-stone-50 px-4 py-3 md:col-span-2"
              placeholder="Inquiry"
            />
            <textarea
              className="min-h-32 rounded-[1.25rem] border border-stone-200 bg-stone-50 px-4 py-3 md:col-span-2"
